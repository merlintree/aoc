...
func main() {
	...
	fmt.Printf("\nDay 1 (part 1): %d", day1part1(data[0]))
	fmt.Printf("\nDay 1 (part 2): %d", day1part2(data[0]))
	fmt.Printf("\nDay 2 (part 1): %d", day2part1(data[1]))
	fmt.Printf("\nDay 2 (part 2): %d", day2part2(data[1]))
	fmt.Printf("\nDay 3 (part 3): %d", day3part1(data[2]))
}
